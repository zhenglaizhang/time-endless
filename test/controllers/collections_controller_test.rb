...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference('Collection.count') do
      post collections_url, params: { collection: { description: @collection.description, title: @collection.title } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { description: @collection.description, title: @collection.title } }
